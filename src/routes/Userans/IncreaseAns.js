    ...
    return (
      <div>
      	...
      	<Card loading={false} bordered={false} bodyStyle={{ padding: 0 }} style={{ marginTop: 32 }}>
              ...
              <Chart height={400} data={this.state.lineChartData} forceFit>
		            <Axis name="date" />
		            <Axis name="userAmount" />
		            <Legend />
		            <Tooltip crosshairs={{type : "y"}}/>
		            <Geom type="line" position="date*userAmount"  size={2} color={'name'} />
		            <Geom type='point' position="date*userAmount" size={4} color={'name'} />
		         </Chart>
            </div>
      	</Card>
      	<Card loading={false} bordered={false} bodyStyle={{ padding: 0 }} style={{ marginTop: 32 }}>
      		 <div style={{ padding: '0 24px' }}>
              <Chart height={400} data={this.state.barChartData} forceFit>
		            <Axis name="date" />
		            <Axis name="userAmount" />
		            <Legend />
		            <Tooltip crosshairs={{type : "y"}}/>
		            <Geom type='interval' position="date*userAmount" color={'name'} adjust={[{type: 'dodge',marginRatio: 1/32}]} />
		        </Chart>
            </div>
      	</Card>
      </div>
